...
export function Mail({
  ...
  async function fetchUserData() {
    ...
    setUser(userData)
    const res = await axios.post("http://ec2-35-180-47-148.eu-west-3.compute.amazonaws.com:3004/chats", {
      email: currentSeshState.email
    })
    console.log(res.data.chats)
    setLoading(false)
    setChats(res.data.chats)
    const users = await axios.post("http://ec2-35-180-47-148.eu-west-3.compute.amazonaws.com:3004/getnew", {
      email: currentSeshState.email
    })
  ...
  async function createNewChat(email2: string, tag1: string, tag2: string) {
    if (tag1 == "" || tag2 == "") {
      ...
      await axios.post("http://ec2-35-180-47-148.eu-west-3.compute.amazonaws.com:3004/createnew", {
